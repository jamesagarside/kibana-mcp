...
def wait_for_alerts(kibana_base_url, auth, rule_name):
...
def main():
    ...
    # Exit with non-zero status if alerts couldn't be verified, useful for CI/automation
    # sys.exit(0 if alerts_verified else 1)
